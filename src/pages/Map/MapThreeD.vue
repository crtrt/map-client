...
<!--            <el-col :span="2">-->
<!--                <el-button @click="satelliteMap"  size="mini">卫星地图</el-button>-->
<!--            </el-col>-->
        </el-row>
        ...
        methods: {
            ...
            initCar(){
                ...
                this.marker = new AMap.Marker({
                    ...
                    offset: new AMap.Pixel(-13, -26),//调整图片偏移
            ...
            changeSpeed(markerSpeed){
                ...
                this.time=Math.round(this.distance/markerSpeed)
                if(this.isPlay){
                    this.playAnimation();
                }
            ...
            satelliteMap(){
                ...
                let buildingLayer = new AMap.Buildings(); //实例化3D地图图层
                buildingLayer.setMap(this.map); //在map中添加3D图层
